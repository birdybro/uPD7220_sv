...
test-timing: $(VENV_STAMP)
	$(VENV_PYTHON) -m pytest tests/model/test_video_timing.py tests/model/test_vertical_timing.py tests/model/test_memif_model.py tests/model/test_partitions_model.py tests/model/test_refresh_model.py tests/model/test_wdat_model.py tests/test_rtl_video_timing.py tests/test_rtl_vertical_timing.py tests/test_rtl_memif.py tests/test_rtl_display_fetch.py tests/test_rtl_refresh.py tests/test_rtl_wdat.py
